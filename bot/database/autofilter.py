...
class FiltersDb(MongoDb):
    ...
    async def get_search_results(self, query: str, file_type: str = None, max_results: int = 10, offset: int = 0, filter: bool = False):  # type: ignore
        ...
        if file_type:
            filter_["file_type"] = file_type  # type: ignore
